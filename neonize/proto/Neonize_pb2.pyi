...
class Message(google.protobuf.message.Message):
    ...
    @property
    def AdditionalNodes(self) -> Global___Node: ...
    def __init__(
        self,
        *,
