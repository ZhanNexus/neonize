...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'Z3go.mau.fi/whatsmeow/proto/instamadilloCoreTypeMedia'
  _globals['_STATICPHOTO'].fields_by_name['scanLengths']._loaded_options = None
  _globals['_STATICPHOTO'].fields_by_name['scanLengths']._serialized_options = b'\020\001'
  _globals['_VOICE'].fields_by_name['waveforms']._loaded_options = None
  _globals['_VOICE'].fields_by_name['waveforms']._serialized_options = b'\020\001'
